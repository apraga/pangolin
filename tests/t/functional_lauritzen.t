...
#-------------------------------------------------------------------------------
# Functional testing with Lauritzen test case.
...
my $folder_in = $folder."input/gaussianhills_80lat/";
my $folder_out = $folder."tests/output_lauritzen/";

my $test = new Functional("lauritzen");
#$test->set_io("ascii");
$test->set_nmin($n_min);
$test->set_nmax($n_max);
